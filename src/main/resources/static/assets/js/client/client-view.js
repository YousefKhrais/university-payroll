(() => {
    ...
    $((function (a) {
        ...
        $("#task-list").DataTable((e(r = {order: [[0, "desc"]]}, "order", []), e(r, "columnDefs", [{
            ...
            sSearch: ""
        }), r)), $("#files-tables").DataTable((e(o = {order: [[0, "desc"]]}, "order", []), e(o, "columnDefs", [{
            orderable: !1,
            targets: [3]
        }]), e(o, "language", {
            searchPlaceholder: "Search...",
            ...
            searchPlaceholder: "Search...",
            sSearch: ""
        }), l)), $("#invoice-tables").DataTable((e(s = {order: [[0, "desc"]]}, "order", []), e(s, "columnDefs", [{
            orderable: !1,
            targets: [6]
        }]), e(s, "language", {
            searchPlaceholder: "Search...",
            sSearch: ""
        }), s)), $("#ticket-tables").DataTable((e(c = {order: [[0, "desc"]]}, "order", []), e(c, "columnDefs", [{
            orderable: !1,
            targets: [5]
        }]), e(c, "language", {
            searchPlaceholder: "Search...",
            sSearch: ""
        }), c)), $(".fc-datepicker").datepicker({
            dateFormat: "dd M yy",
